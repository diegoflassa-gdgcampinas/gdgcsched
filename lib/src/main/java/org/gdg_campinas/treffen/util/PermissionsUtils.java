...
public class PermissionsUtils {
    ...
    private static Snackbar displayPermissionDeniedAppInfoResolutionSnackbar(
        ...
        Snackbar snackbar = Snackbar.make(view, messageResId, length)
                                    .setAction(org.gdg_campinas.treffen.lib.R.string.ok, new View.OnClickListener() {
                                        @Override
                                        public void onClick(final View v) {
                                            LogUtils.LOGI(TAG, "Invoking App Info screen");
                                            final Intent intent =
                                                    new Intent(
    ...
    public static Snackbar displayPermissionDeniedSnackbar(@NonNull final Activity activity,
        ...
        snackbar.setAction(org.gdg_campinas.treffen.lib.R.string.ok, new View.OnClickListener() {
            @Override
            public void onClick(final View v) {
                snackbar.dismiss();
            }
