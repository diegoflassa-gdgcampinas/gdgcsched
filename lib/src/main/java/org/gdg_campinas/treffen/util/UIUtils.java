...
public class UIUtils {
    ...
    /**
     * Format and return the given session time and {@link ScheduleContract.Rooms} values using {@link
    ...
    public static String formatSessionSubtitle(long intervalStart, long intervalEnd,
        ...
        if (sessionEnded && !conferenceEnded) {
            return context.getString(org.gdg_campinas.treffen.lib.R.string.session_finished);
        }

        if (roomName == null) {
            roomName = context.getString(org.gdg_campinas.treffen.lib.R.string.unknown_room);
        }
    ...
    private static final int[] RES_IDS_ACTION_BAR_SIZE = {org.gdg_campinas.treffen.lib.R.attr.actionBarSize};
    ...
    int getSessionIcon(int sessionType) {
        switch (sessionType) {
            case ScheduleItem.SESSION_TYPE_SESSION:
                return org.gdg_campinas.treffen.lib.R.drawable.ic_session;
            case ScheduleItem.SESSION_TYPE_CODELAB:
                return org.gdg_campinas.treffen.lib.R.drawable.ic_codelab;
            case ScheduleItem.SESSION_TYPE_BOXTALK:
                return org.gdg_campinas.treffen.lib.R.drawable.ic_sandbox;
            case ScheduleItem.SESSION_TYPE_MISC:
            default:
                return org.gdg_campinas.treffen.lib.R.drawable.ic_misc;
        }
    }
    ...
    int getBreakIcon(String breakTitle) {
        if (!TextUtils.isEmpty(breakTitle)) {
            if (breakTitle.contains("After") || breakTitle.contains("Concert")) {
                return org.gdg_campinas.treffen.lib.R.drawable.ic_afterhours;
            } else if (breakTitle.contains("Badge")) {
                return org.gdg_campinas.treffen.lib.R.drawable.ic_badge_pickup;
        ...
        return org.gdg_campinas.treffen.lib.R.drawable.ic_food;
    }
