...
public class MapUtils {
    ...
    public static GeoJsonPointStyle createPinMarker(@NonNull Context context, String title) {
        final BitmapDescriptor icon =
                BitmapDescriptorFactory.fromBitmap(
                        UIUtils.drawableToBitmap(context, org.gdg_campinas.treffen.lib.R.drawable.map_marker_unselected));
    ...
    private static IconGenerator getLabelIconGenerator(Context c) {
        ...
        iconFactory.setTextAppearance(org.gdg_campinas.treffen.lib.R.style.TextApparance_Map_Label);
    ...
    public static Bitmap getIconMarkerBitmap(Context context, String iconType, boolean isActive) {
        ...
        if (isActive) {
            iconBitmap = UIUtils.tintBitmap(iconBitmap,
                    ContextCompat.getColor(context, org.gdg_campinas.treffen.lib.R.color.map_active_icon_tint));
        }
        return iconBitmap;
    }
    ...
    public static void clearDiskCache(Context c) {
        ...
        if (cache != null) {
            try {
                LogUtils.LOGD(TAG, "Clearing map tile disk cache");
                cache.delete();
                cache.close();
            } catch (IOException e) {
                // ignore
