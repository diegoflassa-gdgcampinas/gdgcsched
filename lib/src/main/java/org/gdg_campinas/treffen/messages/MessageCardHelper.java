...
package org.gdg_campinas.treffen.messages;
...
public class MessageCardHelper {
    ...
    public static MessageData getSimpleMessageCardData(
      final ConfMessageCardUtils.ConfMessageCard card) {
        ...
        messageData.setEndButtonStringResourceId(org.gdg_campinas.treffen.lib.R.string.ok);
    ...
    public static MessageData getConferenceOptInMessageData() {
        MessageData messageData = new MessageData();
        messageData.setMessageStringResourceId(org.gdg_campinas.treffen.lib.R.string.explore_io_msgcards_ask_opt_in);
        messageData.setStartButtonStringResourceId(org.gdg_campinas.treffen.lib.R.string.explore_io_msgcards_answer_no);
        messageData.setEndButtonStringResourceId(org.gdg_campinas.treffen.lib.R.string.explore_io_msgcards_answer_yes);
    ...
    public static MessageData getNotificationsOptInMessageData() {
        MessageData messageData = new MessageData();
        messageData.setMessageStringResourceId(org.gdg_campinas.treffen.lib.R.string.explore_io_notifications_ask_opt_in);
        messageData.setStartButtonStringResourceId(org.gdg_campinas.treffen.lib.R.string.explore_io_msgcards_answer_no);
        messageData.setEndButtonStringResourceId(org.gdg_campinas.treffen.lib.R.string.explore_io_msgcards_answer_yes);
        ...
        messageData.setStartButtonClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                LogUtils.LOGD(TAG, "Marking notifications question answered with decline.");
        ...
        messageData.setEndButtonClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                LogUtils.LOGD(TAG, "Marking notifications messages question answered with affirmation.");
                ConfMessageCardUtils.setDismissedConfMessageCard(view.getContext(),
    ...
    public static MessageData getWifiSetupMessageData() {
        MessageData messageData = new MessageData();
        messageData.setMessageStringResourceId(org.gdg_campinas.treffen.lib.R.string.question_setup_wifi_card_text);
        messageData.setStartButtonStringResourceId(org.gdg_campinas.treffen.lib.R.string.explore_io_msgcards_answer_no);
        messageData.setEndButtonStringResourceId(org.gdg_campinas.treffen.lib.R.string.explore_io_msgcards_answer_yes);
        messageData.setIconDrawableId(org.gdg_campinas.treffen.lib.R.drawable.message_card_wifi);
    ...
    public static MessageData notSignedInCard() {
        MessageData messageData = new MessageData();
        messageData.setMessageStringResourceId(org.gdg_campinas.treffen.lib.R.string.signin_message);
        messageData.setStartButtonStringResourceId(org.gdg_campinas.treffen.lib.R.string.signin_prompt_skip);
        messageData.setEndButtonStringResourceId(org.gdg_campinas.treffen.lib.R.string.signin_prompt);
        return messageData;
    }
    ...
    public static MessageData signedInMessageCard() {
        ...
        messageData.setMessageStringResourceId(
                org.gdg_campinas.treffen.lib.R.string.signed_in_card_message);
        messageData.setStartButtonStringResourceId(org.gdg_campinas.treffen.lib.R.string.signin_prompt_dismiss);
        return messageData;
    }
    ...
    public static MessageData getNextMessageCard(@NonNull Context context) {
        ...
        if (RegistrationUtils.isRegisteredAttendee(context) ==
            ...
            if (ConfMessageCardUtils.isConfMessageCardsEnabled(context)) {
                LogUtils.LOGD(TAG, "Conf cards Enabled");
                ...
                LogUtils.LOGD(TAG, "Simple cards");
