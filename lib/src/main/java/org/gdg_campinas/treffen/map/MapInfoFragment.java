...
public abstract class MapInfoFragment extends Fragment
    ...
    private static final String QUERY_ARG_ICONTYPE = "icontype";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mTitle = (TextView) root.findViewById(org.gdg_campinas.treffen.lib.R.id.map_info_title);
        mSubtitle = (TextView) root.findViewById(org.gdg_campinas.treffen.lib.R.id.map_info_subtitle);
        mIcon = (ImageView) root.findViewById(org.gdg_campinas.treffen.lib.R.id.map_info_icon);
        mList = (RecyclerView) root.findViewById(org.gdg_campinas.treffen.lib.R.id.map_info_list);
    ...
    public void showFirstSessionTitle(String roomId, String roomTitle, int roomType,
                                      String iconType) {
        loadSessions(roomId,roomTitle,roomType, QUERY_TOKEN_SUBTITLE, iconType);
    }

    /**
     * Called when a session list is to be displayed and has to be loaded.
     */
    public void showSessionList(String roomId, String roomTitle, int roomType, String iconType) {
        loadSessions(roomId,roomTitle,roomType, QUERY_TOKEN_SESSION_ROOM, iconType);
    }
    ...
    private void setHeader(@DrawableRes int icon, String title, String subTitle) {
        mIcon.setImageResource(icon == 0 ? org.gdg_campinas.treffen.lib.R.drawable.map_marker_selected : icon);
    ...
    private View.OnClickListener mOnClickListener = new View.OnClickListener() {
        ...
        public void onClick(final View v) {
            String sessionId = (String) v.getTag(org.gdg_campinas.treffen.lib.R.id.tag_session_id);
            if (sessionId != null) {
    ...
    private static class DividerDecoration extends RecyclerView.ItemDecoration {
        ...
        public DividerDecoration(Context context) {
            ...
            mPaint.setColor(ResourcesCompat.getColor(resources, org.gdg_campinas.treffen.lib.R.color.divider,
                    context.getTheme()));
            mHeight = resources.getDimensionPixelSize(org.gdg_campinas.treffen.lib.R.dimen.divider_height);
        }
    ...
    private static class SessionAdapter extends RecyclerView.Adapter<ItemHolder> {
        ...
        public void onBindViewHolder(final ItemHolder holder, final int position) {
            ...
            holder.itemView.setTag(org.gdg_campinas.treffen.lib.R.id.tag_session_id, sessionId);
    ...
    private static class ItemHolder extends RecyclerView.ViewHolder {
        ...
        public ItemHolder(LayoutInflater inflater, ViewGroup parent) {
            super(inflater.inflate(org.gdg_campinas.treffen.lib.R.layout.map_item_session, parent, false));
            title = (TextView) itemView.findViewById(org.gdg_campinas.treffen.lib.R.id.map_item_title);
            text = (TextView) itemView.findViewById(org.gdg_campinas.treffen.lib.R.id.map_item_text);
            image = (ImageView) itemView.findViewById(org.gdg_campinas.treffen.lib.R.id.map_item_image);
        }
