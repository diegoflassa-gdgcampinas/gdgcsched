...
public class MapFragment extends com.google.android.gms.maps.SupportMapFragment implements
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        ICON_ACTIVE = BitmapDescriptorFactory.fromBitmap(
                UIUtils.drawableToBitmap(getContext(), org.gdg_campinas.treffen.lib.R.drawable.map_marker_selected));
        ICON_NORMAL = BitmapDescriptorFactory.fromBitmap(
                UIUtils.drawableToBitmap(getContext(), org.gdg_campinas.treffen.lib.R.drawable.map_marker_unselected));

        mMap = googleMap;
        mMap.setMapStyle(MapStyleOptions.loadRawResourceStyle(getContext(), org.gdg_campinas.treffen.lib.R.raw.maps_style));
