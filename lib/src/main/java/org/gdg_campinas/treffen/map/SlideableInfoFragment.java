...
public class SlideableInfoFragment extends MapInfoFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mHeightTitleOnly = resources
                .getDimensionPixelOffset(org.gdg_campinas.treffen.lib.R.dimen.map_slideableinfo_height_titleonly);
        mHeightVenue = resources
                .getDimensionPixelOffset(org.gdg_campinas.treffen.lib.R.dimen.map_slideableinfo_height_venue);
        mHeightSession = resources
                .getDimensionPixelOffset(org.gdg_campinas.treffen.lib.R.dimen.map_slideableinfo_height_session);
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return super.onCreateView(inflater, container, savedInstanceState,
                org.gdg_campinas.treffen.lib.R.layout.map_info_bottom);
    }

    @Override
    public void onViewCreated(final View view, final Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
        mCoordinator = (CoordinatorLayout) view.findViewById(org.gdg_campinas.treffen.lib.R.id.map_coordinator);
        mBottomSheet = mCoordinator.findViewById(org.gdg_campinas.treffen.lib.R.id.map_bottomsheet);
