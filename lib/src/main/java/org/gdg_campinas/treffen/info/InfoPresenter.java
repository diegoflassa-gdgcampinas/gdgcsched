...
import static org.gdg_campinas.treffen.util.FirebaseRemoteConfigUtil.getRemoteConfigSequence;
...
public class InfoPresenter implements InfoContract.Presenter {
    ...
    private void applyRemoteConfigToEventInfo(EventInfo eventInfo) {
        String wiFiNetwork = FirebaseRemoteConfig.getInstance()
                .getString(mContext.getString(org.gdg_campinas.treffen.lib.R.string.default_wifi_network_key));
        String wiFiPassword = FirebaseRemoteConfig.getInstance()
                .getString(mContext.getString(org.gdg_campinas.treffen.lib.R.string.default_wifi_password_key));
        String sandboxDescription = getRemoteConfigSequence(
                mContext.getString(org.gdg_campinas.treffen.lib.R.string.event_sandbox_description_key));
        String codeLabsDescription = getRemoteConfigSequence(
                mContext.getString(org.gdg_campinas.treffen.lib.R.string.event_code_labs_description_key));
        String officeHoursDescription = getRemoteConfigSequence(
                mContext.getString(org.gdg_campinas.treffen.lib.R.string.event_office_hours_description_key));
        String afterHoursDescription = getRemoteConfigSequence(
                mContext.getString(org.gdg_campinas.treffen.lib.R.string.event_after_hours_description_key));
    ...
    private void applyRemoteConfigToTravelInfo(TravelInfo travelInfo) {
        String travelShuttleService = getRemoteConfigSequence(
                mContext.getString(org.gdg_campinas.treffen.lib.R.string.travel_shuttle_service_description_key));
        String travelCarpoolingParking = getRemoteConfigSequence(
                mContext.getString(org.gdg_campinas.treffen.lib.R.string.travel_carpooling_parking_description_key));
        String travelPublicTransportation = getRemoteConfigSequence(
                mContext.getString(org.gdg_campinas.treffen.lib.R.string.travel_public_transportation_description_key));
        String travelBiking = getRemoteConfigSequence(
                mContext.getString(org.gdg_campinas.treffen.lib.R.string.travel_biking_description_key));
        String travelRideSharing = getRemoteConfigSequence(
                mContext.getString(org.gdg_campinas.treffen.lib.R.string.travel_ride_sharing_description_key));
    ...
    private void applyRemoteConfigToAboutInfo(AboutInfo aboutInfo) {
        String stayInformedDescription = getRemoteConfigSequence(
                mContext.getString(org.gdg_campinas.treffen.lib.R.string.faq_stay_informed_description_key));
        aboutInfo.setStayInformedDescription(stayInformedDescription);

        String contentFormatsDescription = getRemoteConfigSequence(
                mContext.getString(org.gdg_campinas.treffen.lib.R.string.faq_content_formats_description_key));
        ...
        String liveStreamRecordingsDescription = getRemoteConfigSequence(
                mContext.getString(org.gdg_campinas.treffen.lib.R.string.faq_livestream_and_recordings_description_key));
        ...
        String attendanceProTipsDescription = getRemoteConfigSequence(
                mContext.getString(org.gdg_campinas.treffen.lib.R.string.faq_attendance_pro_tips_description_key));
        aboutInfo.setAttendanceProTipsDescription(attendanceProTipsDescription);

        String moreDescription = getRemoteConfigSequence(
                mContext.getString(org.gdg_campinas.treffen.lib.R.string.faq_additional_info_description_key));
