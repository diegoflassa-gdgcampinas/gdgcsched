...
public class MyIOPresenterImpl implements MyIOContract.MyIoPresenter {
    ...
    private MyIOContract.MyIoView mView;
    private MyIOModel mModel;

    MyIOPresenterImpl(Context context, MyIOContract.MyIoView view) {
        mContext = context;
        mView = view;
