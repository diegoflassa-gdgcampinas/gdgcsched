...
public class FeedActivity extends BaseActivity {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        setContentView(org.gdg_campinas.treffen.lib.R.layout.feed_act);
        ...
        FeedFragment feedFragment = (FeedFragment) getSupportFragmentManager()
                .findFragmentById(org.gdg_campinas.treffen.lib.R.id.main_content);
    ...
    protected int getNavigationTitleId() {
        return org.gdg_campinas.treffen.lib.R.string.title_feed;
    }
}
