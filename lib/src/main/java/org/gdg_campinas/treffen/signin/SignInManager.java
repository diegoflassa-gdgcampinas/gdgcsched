...
public class SignInManager {
    ...
    private static final String TAG = LogUtils.makeLogTag(SignInManager.class);
    ...
    public void signIn() {
        LogUtils.LOGD(TAG, "Starting sign in");
    ...
    public void signOut() {
        LogUtils.LOGD(TAG, "Signing out user");
                ...
                new ResultCallback<Status>() {
                    ...
                    public void onResult(@NonNull Status status) {
                        if (status.isSuccess()) {
                            ...
                            LogUtils.LOGW(TAG, "Failed to sign out");
                            if (signInListener != null) {
    ...
    public void onActivityResult(final int requestCode, final int resultCode,
        ...
        if (requestCode == AccountUtils.RC_SIGN_IN) {
            ...
            if (result.isSuccess()) {
                ...
                LogUtils.LOGW(TAG, "Sign in failed");
    ...
    private void firebaseAuthWithGoogle(GoogleSignInAccount acct) {
        LogUtils.LOGD(TAG, "firebaseAuthWithGoogle:" + acct.getId());
                ...
                .addOnCompleteListener(activity, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (!task.isSuccessful()) {
                            LogUtils.LOGW(TAG, "signInWithCredential", task.getException());
                            return;
                        }
    ...
    private void performPostSignOutTasks(Status status) {
        LogUtils.LOGD(TAG, "Successfully signed out.");
    ...
    private Activity getActivity() {
        ...
        if (activity == null) {
            LogUtils.LOGD(TAG, "Activity is null");
        }
        return activity;
    }
    ...
    private SignInListener getSignInListener() {
        ...
        if (signInListner == null) {
            LogUtils.LOGD(TAG, "SignInListener is null");
        }
