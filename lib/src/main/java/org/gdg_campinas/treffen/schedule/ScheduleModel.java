...
import org.gdg_campinas.treffen.util.ThrottledContentObserver;
...
public class ScheduleModel implements Model<ScheduleModel.MyScheduleQueryEnum,
    ...
    private static final String TAG = LogUtils.makeLogTag(ScheduleModel.class);
    /**
    ...
    private final SharedPreferences.OnSharedPreferenceChangeListener mPrefChangeListener =
            new SharedPreferences.OnSharedPreferenceChangeListener() {
                ...
                public void onSharedPreferenceChanged(SharedPreferences sp, String key) {
                    LogUtils.LOGD(TAG, "sharedpreferences key " + key + " changed, maybe reloading data.");
                    if (SettingsUtils.PREF_LOCAL_TIMES.equals(key)) {
                        ...
                        if (mScheduleDataQueryCallback != null) {
                            ...
                            LogUtils.LOGE(TAG, "sharedpreferences key " + key +
