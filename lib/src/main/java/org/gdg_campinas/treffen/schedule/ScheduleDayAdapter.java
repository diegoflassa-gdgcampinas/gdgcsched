...
public class ScheduleDayAdapter extends RecyclerView.Adapter<ViewHolder>
    ...
    public ScheduleDayAdapter(@NonNull Context context, @NonNull SessionItemViewHolder.Callbacks adapterCallbacks,
        ...
        stuckHeaderElevation = context.getResources().getDimension(org.gdg_campinas.treffen.lib.R.dimen.card_elevation);
    ...
    public ViewHolder onCreateViewHolder(final ViewGroup parent, final int viewType) {
        switch (viewType) {
            case ITEM_TYPE_SESSION:
                return SessionItemViewHolder.newInstance(parent, mAdapterCallbacks, ScheduleItemViewHolder.SessionTimeFormat.DURATION);
            ...
            case ITEM_TYPE_TIME_HEADER:
                return new TimeSeperatorViewHolder(
                        LayoutInflater.from(parent.getContext())
                                .inflate(org.gdg_campinas.treffen.lib.R.layout.schedule_item_time_separator, parent, false));
        }
        return null;
    }
