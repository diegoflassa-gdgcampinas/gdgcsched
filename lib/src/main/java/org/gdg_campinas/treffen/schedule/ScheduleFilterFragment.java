...
public class ScheduleFilterFragment extends Fragment implements LoaderCallbacks<Cursor> {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        return inflater.inflate(org.gdg_campinas.treffen.lib.R.layout.schedule_filter_drawer, container, false);
    }

    @Override
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
        mRecyclerView = (RecyclerView) view.findViewById(org.gdg_campinas.treffen.lib.R.id.filters);
        mClearFilters = (Button) view.findViewById(org.gdg_campinas.treffen.lib.R.id.clear_filters);
        ...
        TextViewCompat.setCompoundDrawablesRelativeWithIntrinsicBounds(mClearFilters, null, null,
                AppCompatResources.getDrawable(context, org.gdg_campinas.treffen.lib.R.drawable.ic_clear_all), null);
        mRecyclerView.setHasFixedSize(true);
        mRecyclerView.addItemDecoration(new DividerDecoration(context));
        final View filtersHeader = view.findViewById(org.gdg_campinas.treffen.lib.R.id.filters_header);
        ...
        mAdapter.setSessionFilterAdapterListener(new SessionsFilterAdapter.OnFiltersChangedListener() {
            @Override
    ...
    public void addFilter(TagMetadata.Tag tag) {
        mAdapter.addTag(tag);
    }
    ...
    private void maybeApplyPendingFilterTag() {
        if (mTagMetadata != null && mFilterTag != null) {
            mAdapter.clearAllFilters();
            TagMetadata.Tag[] tags = mTagMetadata.getTags(mFilterTag);
