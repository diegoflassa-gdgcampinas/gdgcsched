...
import org.gdg_campinas.treffen.util.Constants;
...
public class ConfMessageCardUtils {
    ...
    public static final String TAG = LogUtils.makeLogTag(ConfMessageCardUtils.class);
    ...
    public enum ConfMessageCard {
        ...
        ConfMessageCard(String key, String startTime, String endTime, String simpleMessage) {
            ...
            try {
                ...
                LogUtils.LOGE(TAG, "Invalid time for key = " + key + " and time = " + startTime);
                mStartTime = Long.MIN_VALUE;
            }
            try {
                mEndTime = TimeUtils.parseTimestamp(endTime).getTime();
            } catch (NullPointerException npe) {
                LogUtils.LOGE(TAG, "Invalid time for key = " + key + " and time = " + endTime);
