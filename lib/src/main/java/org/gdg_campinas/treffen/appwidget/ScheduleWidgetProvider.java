...
package org.gdg_campinas.treffen.appwidget;
...
import org.gdg_campinas.treffen.ui.TaskStackBuilderProxyActivity;
...
public class ScheduleWidgetProvider extends AppWidgetProvider {
    ...
    private static final String REFRESH_ACTION =
            "org.gdg_campinas.treffen.appwidget.action.REFRESH";
    private static final String EXTRA_PERFORM_SYNC =
            "org.gdg_campinas.treffen.appwidget.extra.PERFORM_SYNC";
    ...
    public void onReceive(final Context context, Intent widgetIntent) {
        ...
        if (REFRESH_ACTION.equals(action)) {
            LogUtils.LOGD(TAG, "received REFRESH_ACTION from widget");
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        LogUtils.LOGD(TAG, "updating app widget");
        for (int appWidgetId : appWidgetIds) {
            ...
            LogUtils.LOGD(TAG, "setting widget empty view");
