...
public class ScheduleItem implements Cloneable, Comparable<ScheduleItem> {
    ...
    public int reservationStatus = ScheduleContract.MyReservations.RESERVATION_STATUS_UNRESERVED;
    ...
    public boolean isFoodBreak() {
        return ScheduleContract.Blocks.BLOCK_KIND_MEAL.equals(blockKind);
    }

    public boolean isConcert() {
        return ScheduleContract.Blocks.BLOCK_KIND_CONCERT.equals(blockKind);
    }

    public int getBreakIcon() {
        if (blockKind != null) {
            switch (blockKind) {
                case ScheduleContract.Blocks.BLOCK_KIND_MEAL:
                    return R.drawable.ic_food;
                case ScheduleContract.Blocks.BLOCK_KIND_CONCERT:
                    return R.drawable.ic_concert;
                case ScheduleContract.Blocks.BLOCK_KIND_AFTERHOURS:
                    return R.drawable.ic_afterhours;
                case ScheduleContract.Blocks.BLOCK_KIND_BADGEPICKUP:
