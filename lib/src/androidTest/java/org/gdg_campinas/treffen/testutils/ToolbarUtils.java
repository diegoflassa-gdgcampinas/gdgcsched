...
public class ToolbarUtils {
    ...
    public static void checkToolbarIsCompletelyDisplayed() {
        onView(ViewMatchers.withId(org.gdg_campinas.treffen.lib.R.id.toolbar)).check(matches(isCompletelyDisplayed()));
    }

    public static void checkToolbarHidesAfterSwipingRecyclerViewUp(int viewResource) {
        ViewInteraction view = onView(ViewMatchers.withId(org.gdg_campinas.treffen.lib.R.id.toolbar));
