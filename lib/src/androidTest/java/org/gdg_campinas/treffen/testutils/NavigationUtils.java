...
package org.gdg_campinas.treffen.testutils;
...
import org.gdg_campinas.treffen.navigation.NavigationModel.NavigationItemEnum;
...
public class NavigationUtils {
    ...
    public static void checkScreenTitleIsDisplayed(int stringResource) {
        onView(allOf(withParent(ViewMatchers.withId(org.gdg_campinas.treffen.lib.R.id.toolbar)),
...
//    }
    ...
    private static Matcher<View> getSelectedItem(NavigationItemEnum item) {
        return allOf(withText(item.getTitleResource()), ViewMatchers.withId(org.gdg_campinas.treffen.lib.R.id.largeLabel));
    }
}
