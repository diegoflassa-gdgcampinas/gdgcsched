 ...
 */
public class SessionDetailActivity_NotLiveStarredSessionTest {
    ...
    public void liveStreamedText_IsNotVisible() {
        onView(ViewMatchers.withText(org.gdg_campinas.treffen.lib.R.string.session_live_streamed)).check(matches(not(isDisplayed())));
    }

    @Test
    public void watchText_IsNotVisible() {
        onView(ViewMatchers.withId(org.gdg_campinas.treffen.lib.R.id.watch)).check(matches(not(isDisplayed())));
    }

    @Test
    public void headerImage_IsNotVisible() {
        onView(ViewMatchers.withId(org.gdg_campinas.treffen.lib.R.id.session_photo)).check(matches(not(isDisplayed())));
    }
