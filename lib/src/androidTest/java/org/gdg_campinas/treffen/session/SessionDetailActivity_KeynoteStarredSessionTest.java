...
@LargeTest
public class SessionDetailActivity_KeynoteStarredSessionTest {
    ...
    public void speakersSection_IsNotVisible() {
        onView(ViewMatchers.withId(org.gdg_campinas.treffen.lib.R.id.session_speakers_block)).check(matches(not(isDisplayed())));
    }

    @Test
    public void tagSection_IsNotVisible() {
        onView(ViewMatchers.withId(org.gdg_campinas.treffen.lib.R.id.session_tags_container)).check(matches(not(withEffectiveVisibility(
