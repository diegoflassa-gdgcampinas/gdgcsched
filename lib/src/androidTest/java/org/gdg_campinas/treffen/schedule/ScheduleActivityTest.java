...
import org.gdg_campinas.treffen.mockdata.MyScheduleMockItems;
import org.gdg_campinas.treffen.settings.SettingsUtils;
import org.gdg_campinas.treffen.testutils.MatchersHelper;
...
import org.gdg_campinas.treffen.mockdata.StubActivityContext;
import org.gdg_campinas.treffen.navigation.NavigationModel;
import org.gdg_campinas.treffen.testutils.ThrottleContentObserverIdlingResource;
...
//            };
    ...
    public void day2Selected() {
        ...
        onView(ViewMatchers.withText(MyScheduleMockItems.SESSION_TITLE_BEFORE)).check(matches(isDisplayed()));
    }
...
//    }
    ...
    private void showDay(int day) {
        onView(ViewMatchers.withId(org.gdg_campinas.treffen.lib.R.id.view_pager)).perform(MatchersHelper.moveViewPagerToPage(day));
    }
}
