...
import org.gdg_campinas.treffen.testutils.SettingsMockContext;
...
public class NavigationModelTest {
    ...
    public void requestData_LoadItemsForUser_ItemsLoaded() {
        ...
        NavigationModel.NavigationItemEnum[] expectedItems = NavigationConfig.filterOutItemsDisabledInBuildConfig(
