...
public class ModelWithLoaderManagerImplTest {
    ...
    public void setUp() {
        ...
        mQueries[0] = ArchFrameworkHelperForTest.createQueryEnumWithId(1);
        mUserActions = new UserActionEnum[1];
        mUserActions[0] = ArchFrameworkHelperForTest.createUserActionEnumWithId(1);
    ...
    public void getQueries_returnsQueries() {
        ...
        Assert.assertEquals(mQueries, queries);
    }
    ...
    public void getUserActions_returnsUserActions() {
        ...
        Assert.assertEquals(mUserActions, userActions);
    }
    ...
    public void requestData_withNullQueryCallback_throwsException() {
        ...
        mModelWithLoaderManagerImpl.requestData(ArchFrameworkHelperForTest.createQueryEnumWithId(1), null);
    }
    ...
    public void deliverUserAction_withNullUserActionCallback_throwsException() {
        ...
        mModelWithLoaderManagerImpl.deliverUserAction(ArchFrameworkHelperForTest.createUserActionEnumWithId(1), null, null);
    }
    ...
    public void requestData_withInvalidQuery_callbackUpdatedWithError() {
        ...
        final QueryEnum invalidQuery = ArchFrameworkHelperForTest.createQueryEnumWithId(2);
    ...
    public void deliverUserAction_withUserActionWithNoQueryBundle_processesUserAction() {
        ...
        // Given a user action
        UserActionEnum userAction = ArchFrameworkHelperForTest.createUserActionEnumWithId(1);
    ...
    public void deliverUserAction_withUserActionWithQueryBundleWithValidInteger_restartsLoader() {
        ...
        UserActionEnum userAction = ArchFrameworkHelperForTest.createUserActionEnumWithId(1);
        when(mMockBundle.containsKey(ModelWithLoaderManager.KEY_RUN_QUERY_ID)).thenReturn(true);
        when(mMockBundle.get(ModelWithLoaderManager.KEY_RUN_QUERY_ID)).thenReturn(mQueries[0].getId());
    ...
    deliverUserAction_withUserActionWithQueryBundleWithInvalidInteger_callbackUpdatesWithError() {
        ...
        UserActionEnum userAction = ArchFrameworkHelperForTest.createUserActionEnumWithId(1);
        when(mMockBundle.containsKey(ModelWithLoaderManager.KEY_RUN_QUERY_ID)).thenReturn(true);
        when(mMockBundle.get(ModelWithLoaderManager.KEY_RUN_QUERY_ID)).thenReturn(mQueries[0].getId() + 1);
    ...
    deliverUserAction_withUserActionWithQueryBundleWithoutInteger_callbackUpdatedWithError() {
        ...
        UserActionEnum userAction = ArchFrameworkHelperForTest.createUserActionEnumWithId(1);
        when(mMockBundle.containsKey(ModelWithLoaderManager.KEY_RUN_QUERY_ID)).thenReturn(true);
        when(mMockBundle.get(ModelWithLoaderManager.KEY_RUN_QUERY_ID)).thenReturn("String");
