...
public class LoadSessionsServlet extends HttpServlet{
    ...
    /** Auto Generated */
    private static final long serialVersionUID= 7837743964978862552L;
    ...
    protected void doGet(HttpServletRequest req, final HttpServletResponse resp)
        ...
        // Only sessions that are of type TYPE_SESSIONS can be reserved so
        // remove those that do not
        // have this type.
        List<JsonElement> sessionsToRemove= new ArrayList<>();
        for(JsonElement jSession: jSessions){
            // TODO: The keynote should not have a type of TYPE_SESSIONS. Remove
            // this hack once
        ...
        // Get Firebase Database reference to sessions path, add listener for
        // single event.
        ...
        try{
            ...
            for(String sessionId: rtdbSessions.keySet()){
                ...
                // Check that GCS has a matching session and room as the one
                // from RTDB.
                ...
                if(jSession != null){
                    ...
                    // Remove updated sessions from list of sessions to be
                    // added.
        ...
        // Add all sessions that were retrieved from GCS but did not already in
        // RTDB.
