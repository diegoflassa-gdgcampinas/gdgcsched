...
public class VendorInputTest {
  ...
  public void testFetch() throws IOException {
    ...
    JsonArray categories = api.fetch(InputJsonKeys.VendorAPISource.MainTypes.categories);
    JsonArray rooms = api.fetch(InputJsonKeys.VendorAPISource.MainTypes.rooms);
    JsonArray speakers = api.fetch(InputJsonKeys.VendorAPISource.MainTypes.speakers);
    JsonArray topics = api.fetch(InputJsonKeys.VendorAPISource.MainTypes.topics);
